...
public class Level2BossStory extends GameState {

	private Background blackBG;
	private Background story;
	
	public Level2BossStory(GameStateManager gsm) {
		super(gsm);
		init();
	}
	...
	public void init() {
		...
		story = new Background("/Backgrounds/MummyBossStory.png", 0);
	...
	public void handleInput() {
		if(Keys.isPressed(Keys.ESCAPE)) gsm.setState(GameStateManager.LEVEL2BOSS);
	}
}
