...
public class Level2Story extends GameState {

	private Background blackBG;
	private Background story;
	
	public Level2Story(GameStateManager gsm) {
		super(gsm);
		init();
	}
	...
	public void init() {
		...
		story = new Background("/Backgrounds/lvl2Story.png", 0);
	...
	public void handleInput() {
		if(Keys.isPressed(Keys.ESCAPE)) gsm.setState(GameStateManager.LEVEL2STATE);
	}
}
