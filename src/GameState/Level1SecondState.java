...
public class Level1SecondState extends GameState {
	...
	public Level1SecondState(GameStateManager gsm) {
		super(gsm);
		init();
	}
	...
	public void init() {
		...
		// tilemap
			...
			/*	tileMap.setBounds(
				...
				portal.setPosition(2145,425);
				
				// player
				player = new Player(tileMap);
				player.setPosition(60, 800);
	...
	private void setEnemies() {
		...
		spikey.setPosition(1450, 200);
		enemies.add(spikey);
		Ent ent;
		ent = new Ent(tileMap,player);
		ent.setPosition(800, 600);
		enemies.add(ent);
		ent = new Ent(tileMap,player);
		ent.setPosition(600, 500);
		enemies.add(ent);
	}
	...
	public void update() {
		// check keys
				...
				if(portal.contains(player) && Keys.isPressed(0)){
					...
					gsm.setState(GameStateManager.LEVEL1BOSSSTORY);
