...
public class Level2Boss extends GameState {
	...
	public Level2Boss(GameStateManager gsm) {
		super(gsm);
		init();
	}
	...
	public void init() {
		...
		// tilemap
				...
				tileMap.loadMap("/Maps/level2-boss.map");
	...
	private void setEnemies() {
		enemies.clear();
		MummyBoss boss;
		boss = new MummyBoss(tileMap, player, enemies);
